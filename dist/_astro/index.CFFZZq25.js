import{s as d,g as p}from"./_astro_assets.09gEiCms.js";import{c as k,r as h,m as E,u as y}from"./hoisted.B0kaTouZ.js";import"./astro/assets-service.DMKuBMpo.js";const g={src:"/_astro/question.CsKevD8e.png",width:491,height:465,format:"png"},u={src:"/_astro/fileinfo.M0rQw6qx.png",width:807,height:86,format:"png"},F={src:"/_astro/entryFunction.CWV-0_iT.png",width:1919,height:816,format:"png"},f={src:"/_astro/renamed.DrgXV0fX.png",width:861,height:821,format:"png"},x={src:"/_astro/googleColab._N2KWjEW.png",width:725,height:397,format:"png"},m={src:"/_astro/finalResult.qhUeuRYg.png",width:1053,height:650,format:"png"},C={src:"/_astro/question.C2dTRo4D.png",width:498,height:678,format:"png"},b={src:"/_astro/files.7fkW2lfk.png",width:927,height:177,format:"png"},_={src:"/_astro/diff1.C2R5bIcs.png",width:802,height:946,format:"png"},A={src:"/_astro/diff2.DWSPMhxC.png",width:799,height:948,format:"png"},D={src:"/_astro/solution.B9WEySsu.png",width:704,height:46,format:"png"},B={src:"/_astro/question.X0swvYMg.png",width:494,height:519,format:"png"},v={src:"/_astro/logfile.CDQ6qzsm.png",width:697,height:243,format:"png"},w={src:"/_astro/correctSeed.Cj_PW3GY.png",width:659,height:509,format:"png"},T={src:"/_astro/flag.fZPoe3fx.png",width:1036,height:112,format:"png"},S=async function(l){const r={};{const i=new RegExp('__ASTRO_IMAGE_="([^"]*\\./assets/bakamitai/question\\.png[^"]*)"',"g");let a,s=0;for(;(a=i.exec(l))!==null;){const n="./assets/bakamitai/question.png_"+s,e=JSON.parse(a[1].replace(/&#x22;/g,'"')),{src:t,...o}=e;r[n]=await p({src:g,...o}),s++}}{const i=new RegExp('__ASTRO_IMAGE_="([^"]*\\./assets/bakamitai/fileinfo\\.png[^"]*)"',"g");let a,s=0;for(;(a=i.exec(l))!==null;){const n="./assets/bakamitai/fileinfo.png_"+s,e=JSON.parse(a[1].replace(/&#x22;/g,'"')),{src:t,...o}=e;r[n]=await p({src:u,...o}),s++}}{const i=new RegExp('__ASTRO_IMAGE_="([^"]*\\./assets/bakamitai/entryFunction\\.png[^"]*)"',"g");let a,s=0;for(;(a=i.exec(l))!==null;){const n="./assets/bakamitai/entryFunction.png_"+s,e=JSON.parse(a[1].replace(/&#x22;/g,'"')),{src:t,...o}=e;r[n]=await p({src:F,...o}),s++}}{const i=new RegExp('__ASTRO_IMAGE_="([^"]*\\./assets/bakamitai/renamed\\.png[^"]*)"',"g");let a,s=0;for(;(a=i.exec(l))!==null;){const n="./assets/bakamitai/renamed.png_"+s,e=JSON.parse(a[1].replace(/&#x22;/g,'"')),{src:t,...o}=e;r[n]=await p({src:f,...o}),s++}}{const i=new RegExp('__ASTRO_IMAGE_="([^"]*\\./assets/bakamitai/googleColab\\.png[^"]*)"',"g");let a,s=0;for(;(a=i.exec(l))!==null;){const n="./assets/bakamitai/googleColab.png_"+s,e=JSON.parse(a[1].replace(/&#x22;/g,'"')),{src:t,...o}=e;r[n]=await p({src:x,...o}),s++}}{const i=new RegExp('__ASTRO_IMAGE_="([^"]*\\./assets/bakamitai/finalResult\\.png[^"]*)"',"g");let a,s=0;for(;(a=i.exec(l))!==null;){const n="./assets/bakamitai/finalResult.png_"+s,e=JSON.parse(a[1].replace(/&#x22;/g,'"')),{src:t,...o}=e;r[n]=await p({src:m,...o}),s++}}{const i=new RegExp('__ASTRO_IMAGE_="([^"]*\\./assets/cryptic/question\\.png[^"]*)"',"g");let a,s=0;for(;(a=i.exec(l))!==null;){const n="./assets/cryptic/question.png_"+s,e=JSON.parse(a[1].replace(/&#x22;/g,'"')),{src:t,...o}=e;r[n]=await p({src:C,...o}),s++}}{const i=new RegExp('__ASTRO_IMAGE_="([^"]*\\./assets/cryptic/files\\.png[^"]*)"',"g");let a,s=0;for(;(a=i.exec(l))!==null;){const n="./assets/cryptic/files.png_"+s,e=JSON.parse(a[1].replace(/&#x22;/g,'"')),{src:t,...o}=e;r[n]=await p({src:b,...o}),s++}}{const i=new RegExp('__ASTRO_IMAGE_="([^"]*\\./assets/cryptic/diff1\\.png[^"]*)"',"g");let a,s=0;for(;(a=i.exec(l))!==null;){const n="./assets/cryptic/diff1.png_"+s,e=JSON.parse(a[1].replace(/&#x22;/g,'"')),{src:t,...o}=e;r[n]=await p({src:_,...o}),s++}}{const i=new RegExp('__ASTRO_IMAGE_="([^"]*\\./assets/cryptic/diff2\\.png[^"]*)"',"g");let a,s=0;for(;(a=i.exec(l))!==null;){const n="./assets/cryptic/diff2.png_"+s,e=JSON.parse(a[1].replace(/&#x22;/g,'"')),{src:t,...o}=e;r[n]=await p({src:A,...o}),s++}}{const i=new RegExp('__ASTRO_IMAGE_="([^"]*\\./assets/cryptic/solution\\.png[^"]*)"',"g");let a,s=0;for(;(a=i.exec(l))!==null;){const n="./assets/cryptic/solution.png_"+s,e=JSON.parse(a[1].replace(/&#x22;/g,'"')),{src:t,...o}=e;r[n]=await p({src:D,...o}),s++}}{const i=new RegExp('__ASTRO_IMAGE_="([^"]*\\./assets/genz/question\\.png[^"]*)"',"g");let a,s=0;for(;(a=i.exec(l))!==null;){const n="./assets/genz/question.png_"+s,e=JSON.parse(a[1].replace(/&#x22;/g,'"')),{src:t,...o}=e;r[n]=await p({src:B,...o}),s++}}{const i=new RegExp('__ASTRO_IMAGE_="([^"]*\\./assets/genz/logfile\\.png[^"]*)"',"g");let a,s=0;for(;(a=i.exec(l))!==null;){const n="./assets/genz/logfile.png_"+s,e=JSON.parse(a[1].replace(/&#x22;/g,'"')),{src:t,...o}=e;r[n]=await p({src:v,...o}),s++}}{const i=new RegExp('__ASTRO_IMAGE_="([^"]*\\./assets/genz/correctSeed\\.png[^"]*)"',"g");let a,s=0;for(;(a=i.exec(l))!==null;){const n="./assets/genz/correctSeed.png_"+s,e=JSON.parse(a[1].replace(/&#x22;/g,'"')),{src:t,...o}=e;r[n]=await p({src:w,...o}),s++}}{const i=new RegExp('__ASTRO_IMAGE_="([^"]*\\./assets/genz/flag\\.png[^"]*)"',"g");let a,s=0;for(;(a=i.exec(l))!==null;){const n="./assets/genz/flag.png_"+s,e=JSON.parse(a[1].replace(/&#x22;/g,'"')),{src:t,...o}=e;r[n]=await p({src:T,...o}),s++}}return r};async function R(l){return S(l).then(r=>l.replaceAll(/__ASTRO_IMAGE_="([^"]+)"/gm,(i,a)=>{const s=JSON.parse(a.replace(/&#x22;/g,'"')),n=s.src+"_"+s.index;r[n].srcSet&&r[n].srcSet.values.length>0&&(r[n].attributes.srcset=r[n].srcSet.attribute);const{index:e,...t}=r[n].attributes;return d({src:r[n].src,...t})}))}const c=await R(`<h2 id="reverse-engineering">Reverse Engineering<a class="anchor" href="#reverse-engineering">#</a></h2>
<hr>
...
<img __ASTRO_IMAGE_="{&#x22;src&#x22;:&#x22;./assets/genz/flag.png&#x22;,&#x22;alt&#x22;:&#x22;&#x22;,&#x22;index&#x22;:0}"></p>
...
<h3 id="challenges">Challenges<a class="anchor" href="#challenges">#</a></h3>
...
<table><thead><tr><th>Challenges</th><th>Category</th></tr></thead><tbody><tr><td>Garry: Beyond Music’s End 3</td><td>OSINT</td></tr><tr><td>Github is weirdddd 1.0</td><td>Brainfuck</td></tr><tr><td>Github is weirdddd 2.0</td><td>Brainfuck</td></tr></tbody></table>
<h3 id="solution">Solution<a class="anchor" href="#solution">#</a></h3>
<p>@gr1d    wrote a bruteforce tool, <a href="https://github.com/gr1d-init/gitsha" rel="nofollow, noopener, noreferrer" target="_blank">GitSHA<span> ↗</span></a>, for these challenges.</p>
<h4 id="steps">Steps<a class="anchor" href="#steps">#</a></h4>
<ol>
<li>Install the tool.</li>
</ol>
<div class="astro-code astro-code-themes github-light github-dark" style="background-color:#fff;--shiki-dark-bg:#24292e;color:#24292e;--shiki-dark:#e1e4e8; overflow-x: auto;" tabindex="0" data-language="bash"><pre><code><span class="line"><span style="color:#6F42C1;--shiki-dark:#B392F0">git</span><span style="color:#032F62;--shiki-dark:#9ECBFF"> clone</span><span style="color:#032F62;--shiki-dark:#9ECBFF"> https://github.com/gr1d-init/gitsha.git</span></span>
<span class="line"></span></code></pre><span class="language transition-opacity duration-300 absolute top-3 right-3 text-sm text-muted-foreground select-none">bash</span><button class="copy transition-opacity duration-300 opacity-0 absolute top-3 right-3 text-muted-foreground p-1 box-content border border-border rounded bg-primary-foreground" data-code="git clone https://github.com/gr1d-init/gitsha.git
" onclick="
          navigator.clipboard.writeText(this.dataset.code);
          this.classList.add(&#x27;copied&#x27;);
          setTimeout(() => this.classList.remove(&#x27;copied&#x27;), 2000)
...
<div class="astro-code astro-code-themes github-light github-dark" style="background-color:#fff;--shiki-dark-bg:#24292e;color:#24292e;--shiki-dark:#e1e4e8; overflow-x: auto;" tabindex="0" data-language="bash"><pre><code><span class="line"><span style="color:#6F42C1;--shiki-dark:#B392F0">python</span><span style="color:#032F62;--shiki-dark:#9ECBFF"> gitsha.py</span><span style="color:#005CC5;--shiki-dark:#79B8FF"> -r</span><span style="color:#032F62;--shiki-dark:#9ECBFF"> "&#x3C;author's name>/&#x3C;repo's name>"</span></span>
<span class="line"></span></code></pre><span class="language transition-opacity duration-300 absolute top-3 right-3 text-sm text-muted-foreground select-none">bash</span><button class="copy transition-opacity duration-300 opacity-0 absolute top-3 right-3 text-muted-foreground p-1 box-content border border-border rounded bg-primary-foreground" data-code="python gitsha.py -r &#x22;<author&#x27;s name>/<repo&#x27;s name>&#x22;
" onclick="
          navigator.clipboard.writeText(this.dataset.code);
          this.classList.add(&#x27;copied&#x27;);
          setTimeout(() => this.classList.remove(&#x27;copied&#x27;), 2000)
...
<div class="astro-code astro-code-themes github-light github-dark" style="background-color:#fff;--shiki-dark-bg:#24292e;color:#24292e;--shiki-dark:#e1e4e8; overflow-x: auto;" tabindex="0" data-language="plaintext"><pre><code><span class="line"><span>3419</span></span>
<span class="line"><span>4568 #</span></span>
<span class="line"><span>66f8</span></span>
<span class="line"><span>8da4 #</span></span>
<span class="line"><span>a5b6 #</span></span>
<span class="line"><span></span></span></code></pre><span class="language transition-opacity duration-300 absolute top-3 right-3 text-sm text-muted-foreground select-none">plaintext</span><button class="copy transition-opacity duration-300 opacity-0 absolute top-3 right-3 text-muted-foreground p-1 box-content border border-border rounded bg-primary-foreground" data-code="3419
4568 #
66f8
8da4 #
a5b6 #
...
<div class="astro-code astro-code-themes github-light github-dark" style="background-color:#fff;--shiki-dark-bg:#24292e;color:#24292e;--shiki-dark:#e1e4e8; overflow-x: auto;" tabindex="0" data-language="plaintext"><pre><code><span class="line"><span>0067</span></span>
<span class="line"><span>0b3d</span></span>
<span class="line"><span>2a63</span></span>
<span class="line"><span>458e (GitHub 2.0)</span></span>
<span class="line"><span>481f</span></span>
<span class="line"><span>4bec</span></span>
<span class="line"><span>5b27</span></span>
<span class="line"><span>5ef6</span></span>
<span class="line"><span>621e</span></span>
<span class="line"><span>693a</span></span>
<span class="line"><span>724c</span></span>
<span class="line"><span>8f66</span></span>
<span class="line"><span>a24a</span></span>
<span class="line"><span>b2ff</span></span>
<span class="line"><span>c47a</span></span>
<span class="line"><span>cf29</span></span>
<span class="line"><span>cfba (GitHub 1.0)</span></span>
<span class="line"><span>ed44</span></span>
<span class="line"><span>ed90</span></span>
<span class="line"><span>f6aa</span></span>
<span class="line"><span></span></span></code></pre><span class="language transition-opacity duration-300 absolute top-3 right-3 text-sm text-muted-foreground select-none">plaintext</span><button class="copy transition-opacity duration-300 opacity-0 absolute top-3 right-3 text-muted-foreground p-1 box-content border border-border rounded bg-primary-foreground" data-code="0067
0b3d
2a63
458e (GitHub 2.0)
481f
...
" onclick="
          ...
          setTimeout(() => this.classList.remove(&#x27;copied&#x27;), 2000)
        "><div class="ready"><svg class="size-5"><use href="/icons/code.svg#mingcute-clipboard-line"></use></svg></div><div class="success hidden"><svg class="size-5"><use href="/icons/code.svg#mingcute-file-check-line"></use></svg></div></button></div>
<h4 id="flags">Flags<a class="anchor" href="#flags">#</a></h4>
...
<table><thead><tr><th>Challenges</th><th>Category</th></tr></thead><tbody><tr><td>Garry: Beyond Music’s End 3</td><td>EQCTF{w1z4rd_0f_l3g3nds_1n_d1sgu1s3}</td></tr><tr><td>Github is weirdddd 1.0</td><td>EQCTF{hmmmmmmmm_G1t_L3ak_d@_Fl3g}</td></tr><tr><td>Github is weirdddd 2.0</td><td>EQCTF{Brut3333333333_D@_C0mm1t_99}</td></tr></tbody></table>`),G={title:"EQCTF 2025",publishDate:"2025-01-25T00:00:00.000Z",description:"Writeups for Equilibrium Solo CTF 2025",tags:["CTF","RE"],heroImage:{src:"./assets/eqctfbanner.png",color:"#bababa"},language:"English",minutesRead:"9 min read"},I="C:/Users/gr1d/Documents/gr1d-init/gr1d-init.github.io/src/content/post/eqctf2025/index.md",z=void 0;function N(){return`
## Reverse Engineering
---
## Baka Mitai
...
| Github is weirdddd 2.0 | EQCTF{Brut3333333333_D@_C0mm1t_99} |`}function M(){return c}function P(){return[{depth:2,slug:"reverse-engineering",text:"Reverse Engineering"},{depth:2,slug:"baka-mitai",text:"Baka Mitai"},{depth:2,slug:"",text:""},{depth:3,slug:"goals",text:"Goals"},{depth:3,slug:"final-result",text:"Final Result"},{depth:2,slug:"cryptic-token-diffusion",text:"Cryptic Token Diffusion"},{depth:2,slug:"-1",text:""},{depth:3,slug:"goals-1",text:"Goals"},{depth:3,slug:"final-result-1",text:"Final Result"},{depth:2,slug:"gen-z",text:"Gen Z"},{depth:3,slug:"goals-2",text:"Goals"},{depth:3,slug:"final-result-2",text:"Final result"},{depth:2,slug:"github",text:"Github"},{depth:3,slug:"goals-3",text:"Goals"},{depth:3,slug:"challenges",text:"Challenges"},{depth:3,slug:"solution",text:"Solution"},{depth:4,slug:"steps",text:"Steps"},{depth:3,slug:"final-result-3",text:"Final result"},{depth:4,slug:"flags",text:"Flags"}]}const j=k((l,r,i)=>{const{layout:a,...s}=G;return s.file=I,s.url=z,h`${E()}${y(c)}`});export{j as Content,M as compiledContent,j as default,I as file,G as frontmatter,P as getHeadings,N as rawContent,z as url};
